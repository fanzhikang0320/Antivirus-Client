    ...
    <div class="home-container">
      <div class="banner-area">
          ...
          <div class="banner-content">
              <h1 class="page-title">Best Antivirus Software of <span class="blue">{{getMonth()}}</span></h1>
              ...
              <ul class="banner-list-box">
                  ...
                  <li>
                      <span class="icon"></span>
                      <p class="text">Obtain the <strong>cheapest product</strong> on the market</p>
                  </li>
              </ul>
      ...
      <div class="product-area">
        ...
        <div class="product-container" v-else>
            <div class="product-item" v-for="(item,index) in productData" :key="index">
                <!-- <a :href="item.link" class="link-box" target="_blank" rel="noopener noreferrer"> -->
                <div class="most-corner" v-if="index == 0">
                ...
                <div class="product-content">
                    ...
                    <div class="center-content">
                        ...
                        <router-link v-if="item.isShowRead" :to="{name: 'review',query: {productId: item.id}}" rel="noopener noreferrer" class="review">Read Review</router-link>
          ...
          <h2 class="most-popular-area-title area-title">Most Popular Antivirus</h2>
            <div class="most-popular-container">
                ...
                <div class="popular-item popular-left-aside aside" >
                    ...
                    <a href="https://www.anrdoezrs.net/click-100176895-11744641" class="btn" target="_blank" rel="noopener noreferrer">Get BullGuard</a>
                </div>
                <div class="popular-item center popular-center">
                    ...
                    <a href="https://track.totalav.com/5f030579e4a47/click" class="btn" target="_blank" rel="noopener noreferrer">Free Download</a>
                </div>
                <div class="popular-item aside popular-right-aside ">
                    <img src="@/assets/Image/newHome/3.png" alt="" class="picture">
                    <span class="line"></span>
                    <div class="star-box">
                        <Star :max="10" :score="+8.8"/>
                    </div>
                    <ul class="good-list-box">
                        <li>
                            <span class="icon"></span>
                            <p class="text">Quick & easy installation</p>
                        </li>
                        <li>
                            <span class="icon"></span>
                            <p class="text">Proficiently handles huge data</p>
                        </li>

                    </ul>
                    <a href="https://www.jdoqocy.com/click-100176895-10961367" class="btn" target="_blank" rel="noopener noreferrer">Get PandaVPN</a>
                </div>
            </div>
      </div>
        <div class="faq-area">
...
export default {
            ...
            recommendData: [
                {
                    ...
                    score: '9.8',
                    link: 'https://www.xvbelink.com/offer/coupon?a_fid=5176798'
                },
                {
                ...
                },
                {
                    ...
                    score: '9.3',
                    link: 'https://www.privateinternetaccess.com/offer/sale?aff_id=9300&brand=VPNcollection&source=gen&'
                },
            ],
            mostPopularData: []
        }
    ...
    methods: {
        ...
        // getURL(link) {
        //     const reg = /^http(s)?:\/\/(.*?)\//
        //     // window.console.log(reg.exec(link))
        //     return reg.exec(link)
        // }
    },
    mounted() {
        this.handleShow(0);
